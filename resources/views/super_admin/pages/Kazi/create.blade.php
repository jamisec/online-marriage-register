            ...
            <div class="row">
                ...
                <div class="col-md-8 offset-md-2">
                    <div class="card card-primary">
                        ...
                        @endif
                        <form action="/govt/kazis" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" placeholder="ইমেইল" class="form-control" name="email">
                                </div>

                                <div class="form-group">
                                    <label for="phone" class=" form-control-label">ফোন নং</label>
                                    <input type="text" id="phone" placeholder="ফোন নং" class="form-control" name="phone">
                                </div>

                                <div class="form-group">
                                    <label for="password" class=" form-control-label">পাসওয়ার্ড </label>
