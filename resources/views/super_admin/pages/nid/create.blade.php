            ...
            <div class="row">
                ...
                <div class="col-md-8 offset-md-2">
                    <div class="card card-primary">
                        ...
                        @endif
                        <form action="/govt/nids" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body card-block">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" placeholder="Enter your name " class="form-control" name="name_eng">
                                </div>
                                <div class="form-group">
                                    <label for="নাম (বাংলায় )" class=" form-control-label">নাম (বাংলায় )</label>
                                    <input type="text" id="নাম (বাংলায় )" placeholder="নাম (বাংলায় )" class="form-control" name="name">
                                </div>
                                <div class="form-group">
                                    <label for="পিতার নাম (বাংলায় )" class=" form-control-label">পিতার নাম (বাংলায় )</label>
                                    <input type="text" id="পিতার নাম (বাংলায় )" placeholder="পিতার নাম (বাংলায় )" class="form-control" name="fathers_name">
                                </div>
                                <div class="form-group">
                                    <label for="মাতার নাম (বাংলায় )" class=" form-control-label">মাতার নাম (বাংলায় )</label>
                                    <input type="text" id="মাতার নাম (বাংলায় )" placeholder="মাতার নাম (বাংলায় )" class="form-control" name="mothers_name">
                                </div>
                                <div class="form-group">
                                    <label for="ছবি" class=" form-control-label">ছবি </label>
                                    <input type="file" id="" placeholder="photo" class="form-control" name="img">
                                </div>
                                <div class="form-group">
                                    <label for="জন্ম তারিখ" class=" form-control-label">জন্ম তারিখ </label>
                                    <input type="text" id="country" placeholder="YYYY-MM-DD" class="form-control" name="dob">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="division" id="division" class="form-control" @change="loadDist">
                                        ...
                                        <option value="{{$division->bn_name}}">{{$division->bn_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
